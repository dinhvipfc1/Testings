...
# Step 7: Nhập Pass
test_driver.find_element(By.XPATH, '//*[@id="register"]/div[4]/input').send_keys('abc12345')

# Step 8: Nhập lại Pass
test_driver.find_element(By.XPATH, '//*[@id="register"]/div[5]/input').send_keys('abc12345')
